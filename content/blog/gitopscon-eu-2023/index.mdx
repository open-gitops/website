...
released! You can see the full schedule on the [official event website](https://events.linuxfoundation.org/gitopscon-europe/program/schedule/).

GitOpsCon Europe is a virtual event, and we have 2 half days 
