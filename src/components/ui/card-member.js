  ...
  return (
    <div className="group bg-white rounded-xl">
      <a href={to} target="_blank" rel="noopener noreferrer" className="block">
        <div className="py-2 text-gray text-center text-sm border-b-2 border-light transition-colors duration-200 group-hover:text-dark group-hover:border-primary">
          {title}
        </div>
