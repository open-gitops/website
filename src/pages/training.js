...
export default function TrainingPage ({location}) {
    ...
    return (
        <Layout location={location}>
            <Seo title='training and certification' description='Become a professional by getting certified in GitOps' url={location.href}
        image={thumbnail} />
        <Container className="pt-28 lg:pt-48">
        <h1 className="mb-8 lg:mb-12 text-center lg:text-left">Training & Certification</h1>
        <Grid md={2} lg={3}>
